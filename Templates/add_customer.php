...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_customer'])) {
        ...
        $type = $_POST['type'];
        $server = isset($_POST['server']) ? $_POST['server'] : 'default_server';
        $sim_serial = isset($_POST['sim_serial']) ? $_POST['sim_serial'] : 'default_sim_serial';
        ...
        <div class="content">
          <section class="customer-form">
            ...
            <form id="customerForm" method="POST">
              ...
              <input type="text" id="sim_serial" name="sim_serial" value="<?php echo $edit_customer['SIM_Serial_no'] ?? ''; ?>" /> -->
